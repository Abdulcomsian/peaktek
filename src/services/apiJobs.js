...
export async function createJob({ address, name, email, phone }) {
	...
	try {
		const resp = await clientBaseURL.post(`${clientEndPoints.createJob}`, formdata, {
...
export async function getJobApi(id) {
	...
	const resp = await fetch(`https://test7.accrualdev.com/api/get-single/job/${id}`, requestOptions)
...
export async function getJobswithCount() {
	const token = localStorage.getItem('token')
	try {
		const resp = await clientBaseURL.get(`${clientEndPoints.getJobswithCount}`, {
			headers: { Authorization: `Bearer ${token}` },
		})
		return resp
	} catch (error) {
...
export async function getAllStatusJobs(statusId) {
	const token = localStorage.getItem('token')
	try {
		const resp = await clientBaseURL.get(`${clientEndPoints.getAllStatusJobs}/${statusId}`, {
			headers: { Authorization: `Bearer ${token}` },
		})
...
export async function getUserJobs(data) {
	...
	try {
		const resp = clientBaseURL.post(`${clientEndPoints.getWeeklyOrMonlyJobs}`, data, {
			headers: { Authorization: `Bearer ${token}` },
		})
		return resp
	} catch (error) {
...
export async function createSummaryInitialInformation(dataToLoad, jobId) {
	...
	const token = localStorage.getItem('token')
	try {
		const resp = clientBaseURL.post(`${clientEndPoints.createSummaryInitailInformation}/${jobId}`, dataToLoad, {
			headers: { Authorization: `Bearer ${token}` },
		})
		return resp
	} catch (error) {
...
export async function getSummaryInitialInformation(jobId) {
	const token = localStorage.getItem('token')
	try {
		const resp = await clientBaseURL.get(`${clientEndPoints.getSummaryInitialInformation}/${jobId}`, {
			headers: { Authorization: `Bearer ${token}` },
		})
		return resp
	} catch (error) {
...
export async function createSummaryInsurance(dataToLoad, jobId) {
	const token = localStorage.getItem('token')
	try {
		const resp = await clientBaseURL.post(`${clientEndPoints.createSummaryInsurance}/${jobId}`, dataToLoad, {
			headers: { Authorization: `Bearer ${token}` },
		})
		return resp
	} catch (error) {
...
export async function getSummaryInsurance(jobId) {
	const token = localStorage.getItem('token')
	try {
		const resp = await clientBaseURL.get(`${clientEndPoints.getSummaryInsurance}/${jobId}`, {
			headers: { Authorization: `Bearer ${token}` },
		})
		return resp
	} catch (error) {
