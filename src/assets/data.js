...
const limitationsOfLiability = [
  {
    id: 1,
    text: "No implied warranty of merchantability or fitness in connection with supplied roof materials.",
  },
  {
    id: 2,
    text: "PeakTek is not liable for damage to the building or contents, or for loss, injury, or damage to persons or property from defects in materials supplied.",
  },
  {
    id: 3,
    text: "PeakTek is not liable for incidental, special, or consequential damages, direct or indirect.",
  },
  {
    id: 4,
  ...
  {
    id: 5,
    text: "No modifications to this warranty are effective unless in writing and approved by all parties.",
  },
  {
    id: 6,
    text: "This warranty represents the sole and exclusive liability of PeakTek for the roofing job, including application, maintenance, and repair.",
  },
  {
    id: 7,
    text: "THIS WARRANTY REPLACES ALL OTHER WARRANTIES, WRITTEN, ORAL, EXPRESSED, OR IMPLIED, INCLUDING ANY IMPLIED WARRANTY OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE.",
  },
  {
    id: 8,
    text: "This warranty is effective only when executed by an authorized PeakTek representative.",
  },
  {
    id: 9,
    text: "This warranty is not a substitute for a common-sense maintenance program by the owner and does not cover roof abuse from foot traffic or other trades.",
  },
];
const maintenanceData = [
  {
    id: 1,
    text: "Maintain the roof in good condition.",
  },
  {
    id: 2,
    text: "Avoid misuse or abuse of the roof.",
  },
  {
    id: 3,
    text: "Promptly report any issues to PeakTek Roofing & Restoration within the specified time frame.",
  },
];
