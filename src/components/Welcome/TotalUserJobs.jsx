...
export default function TotalUserJobs({ dataDashboard }) {
	return (
		<Card className="md:row-start-2 md:row-end-4">
			<h2 className="col-span-full text-lg font-semibold tracking-wide mb-4">This Week</h2>
			...
			<h2 className="col-span-full text-lg font-semibold tracking-wide mb-3">Month to Date</h2>
