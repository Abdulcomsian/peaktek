...
import { formatPhoneNumber, handlePhoneChange } from "../../../utils/helper";
    ...
    <div className={className}>
      <InputContainer className="flex flex-col md:flex-row justify-between md:mb-4">
        ...
        <Input
          ...
          register={register}
          onChange={(e) => {
            setValue("phone", handlePhoneChange(e));
          }}
          maxLength={12}
          // validate={(value) => {
          // 	return value.length === 12 || 'number should be maximun of 10 numbers'
          // }}
