  ...
  useEffect(() => {
    if (singleJobData) {
      formik.setValues({
        ...
        company_date: formik.values.company_date,
        customer_signature: formik.values.customer_signature,
        customer_printed_name: formik.values.customer_printed_name,
        customer_date: formik.values.customer_date,
      });
    }
  }, [singleJobData]);
