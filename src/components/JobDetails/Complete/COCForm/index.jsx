...
export default function COCForm({ register, control, getValues, pdfUrl, handleSubmit, isSubmitting }) {
	const { id } = useParams()
	...
	return (
		<div className="flex flex-col">
			...
			<form onSubmit={handleSubmit(onSubmit)} className="bg-slate-50 rounded-3xl px-4 py-5">
