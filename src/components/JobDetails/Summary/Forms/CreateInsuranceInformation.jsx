...
export default function CreateInsuranceInformation() {
	...
	return (
		<form action="" onSubmit={handleSubmit(onsubmit)} className="bg-stone-200 rounded-2xl p-4">
			<div className="flex items-center justify-between mb-4">
				<h2 className="font-semibold uppercase">Insurance information</h2>
			</div>
			<div className="bg-white divide-x-2 divide-stone-300 rounded-2xl p-4 px-3 grid grid-cols-1 sm:grid-cols-[2fr_1.5fr] mb-4 gap-3 max-w-screen-xl">
